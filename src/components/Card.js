...
const Card = (props) => {
  ...
  return (
    <div
      data-testid="resCard"
      className="border border-gray-300 bg-white rounded-lg p-2 shadow-md hover:shadow-lg transition min-h-100"
    >
      <img
      ...
      <h4 data-testid="test-rating" className="text-yellow-500 font-medium">{avgRating} ⭐</h4>
